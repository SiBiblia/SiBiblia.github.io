...
export function init_exam_database(){
	...
	db.q_memory__ = { 
		choose_yes: true,
		context: ["ctx_people", "ctx_like_jesus", "ctx_memory", ],
		htm_stm: "q_memory",
		img_href: "memory.webp", 
		answers: {
			a_simple_YES: { img_pos: rgt, },
			a_simple_NO: { img_pos: lft, },
		},
	...
	db.q_resemblance__ = { 
		choose_yes: true,
		context: ["ctx_people", "ctx_like_jesus", "ctx_resemblance", ],
		htm_stm: "q_resemblance",
		img_href: "resemblance.webp", 
		answers: {
			a_simple_YES: { img_pos: rgt, },
			a_simple_NO: { img_pos: lft, },
		},
	...
	db.o_is_about_bible__ = { 
		...
		activated_if: {
			...
			c5: { q_memory__: { a_simple_NO: "on", }, },
			c6: { q_resemblance__: { a_simple_NO: "on", }, },
			c7: { q_for_all__: { a_simple_NO: "on", }, },
			c8: { q_not_yet__: { a_simple_NO: "on", }, },
			c9: { q_new_earth__: { a_simple_NO: "on", }, },
		},
	};	
	...
	db.o_accepting_physical_resu__ = { 
		htm_stm: "o_accepting_physical_resu",
		htm_nam: "o_accepting_physical_resu_nm",
		context: ["ctx_jesus_physical", ],
		activated_if: {
			c1: { q_physical_resu__: { a_simple_NO: "on", }, q_jesus_physical__: { q4_1__verse1_str: "on", q4_1__verse2_str: "on", q4_1__verse3_str: "on", q4_1__verse4_str: "on", q4_1__verse5_str: "on", q4_1__verse6_str: "on", q4_1__verse7_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_die_again__ = { 
		htm_stm: "o_accepting_die_again",
		htm_nam: "o_accepting_die_again_nm",
		context: ["ctx_jesus_not_die", ],
		activated_if: {
			c1: { q_die_again__: { a_simple_NO: "on", }, q_jesus_not_die__: { q5_1__verse1_str: "on", q5_1__verse2_str: "on", q5_1__verse3_str: "on", q5_1__verse4_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_alive_in_body_and_spirit__ = { 
		htm_stm: "o_accepting_alive_in_body_and_spirit",
		htm_nam: "o_accepting_alive_in_body_and_spirit_nm",
		context: ["ctx_jesus_body_and_spirit", ],
		activated_if: {
			c1: { q_alive_in_body_and_spirit__: { a_simple_NO: "on", }, jesus_in_heaven__: { q6_1__verse1_str: "on", q6_1__verse2_str: "on", q6_1__verse3_str: "on", q6_1__verse4_str: "on", q6_1__verse5_str: "on", q6_1__verse6_str: "on", q6_1__verse7_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_like_jesus_body__ = { 
		htm_stm: "o_accepting_like_jesus_body",
		htm_nam: "o_accepting_like_jesus_body_nm",
		context: ["ctx_people_like_jesus", ],
		activated_if: {
			c1: { q_like_jesus__: { a_simple_NO: "on", }, ours_like_jesus__: { q7_1__verse1_str: "on", q7_1__verse2_str: "on", q7_1__verse3_str: "on", q7_1__verse4_str: "on", q7_1__verse5_str: "on", q7_1__verse6_str: "on", q7_1__verse7_str: "on", 
			}, },
		},
	};	

	db.ours_memory__ = { 
		htm_stm: "q7_2__memory",
		context: ["ctx_people_memory", ],
		presentation: "q7_2__memory_sec",
		is_multi: true,
		answers: {
			q7_2__verse1_str: { rclk_href: "q7_2__verse1_href", should_on: "q7_2__verse1_should", },
			q7_2__verse2_str: { rclk_href: "q7_2__verse2_href", should_on: "q7_2__verse2_should", },
			q7_2__verse3_str: { rclk_href: "q7_2__verse3_href", should_on: "q7_2__verse3_should", },
			q7_2__verse4_str: { rclk_href: "q7_2__verse4_href", should_on: "q7_2__verse4_should", },
			q7_2__verse5_str: { rclk_href: "q7_2__verse5_href", should_on: "q7_2__verse5_should", },
			q7_2__verse6_str: { rclk_href: "q7_2__verse6_href", should_on: "q7_2__verse6_should", },
			q7_2__verse7_str: { rclk_href: "q7_2__verse7_href", should_on: "q7_2__verse7_should", },
		},
		activated_if: {
			c1: { q_memory__: { a_simple_NO: "on", }, },
		},
	};
	
	db.o_denial_memory__ = { 
		htm_stm: "o_denial_memory",
		htm_nam: "o_denial_memory_nm",
		context: ["ctx_people_memory", ],
		activated_if: {
			c1: { ours_memory__: { q7_2__verse1_str: "off", }, },
			c2: { ours_memory__: { q7_2__verse2_str: "off", }, },
			c3: { ours_memory__: { q7_2__verse3_str: "off", }, },
			c4: { ours_memory__: { q7_2__verse4_str: "off", }, },
			c5: { ours_memory__: { q7_2__verse5_str: "off", }, },
			c6: { ours_memory__: { q7_2__verse6_str: "off", }, },
			c7: { ours_memory__: { q7_2__verse7_str: "off", }, },
		},
	};	

	db.o_accepting_memory__ = { 
		htm_stm: "o_accepting_memory",
		htm_nam: "o_accepting_memory_nm",
		context: ["ctx_people_memory", ],
		activated_if: {
			c1: { q_memory__: { a_simple_NO: "on", }, ours_memory__: { q7_2__verse1_str: "on", q7_2__verse2_str: "on", q7_2__verse3_str: "on", q7_2__verse4_str: "on", q7_2__verse5_str: "on", q7_2__verse6_str: "on", q7_2__verse7_str: "on", 
			}, },
		},
	};	

	db.ours_resemblance__ = { 
		htm_stm: "q7_3__resemblance",
		context: ["ctx_people_resemblance", ],
		presentation: "q7_3__resemblance_sec",
		is_multi: true,
		answers: {
			q7_3__verse1_str: { rclk_href: "q7_3__verse1_href", should_on: "q7_3__verse1_should", },
			q7_3__verse2_str: { rclk_href: "q7_3__verse2_href", should_on: "q7_3__verse2_should", },
			q7_3__verse3_str: { rclk_href: "q7_3__verse3_href", should_on: "q7_3__verse3_should", },
			q7_3__verse4_str: { rclk_href: "q7_3__verse4_href", should_on: "q7_3__verse4_should", },
			q7_3__verse5_str: { rclk_href: "q7_3__verse5_href", should_on: "q7_3__verse5_should", },
			q7_3__verse6_str: { rclk_href: "q7_3__verse6_href", should_on: "q7_3__verse6_should", },
			q7_3__verse7_str: { rclk_href: "q7_3__verse7_href", should_on: "q7_3__verse7_should", },
		},
		activated_if: {
			c1: { q_resemblance__: { a_simple_NO: "on", }, },
		},
	};
	
	db.o_denial_resemblance__ = { 
		htm_stm: "o_denial_resemblance",
		htm_nam: "o_denial_resemblance_nm",
		context: ["ctx_people_resemblance", ],
		activated_if: {
			c1: { ours_resemblance__: { q7_3__verse1_str: "off", }, },
			c2: { ours_resemblance__: { q7_3__verse2_str: "off", }, },
			c3: { ours_resemblance__: { q7_3__verse3_str: "off", }, },
			c4: { ours_resemblance__: { q7_3__verse4_str: "off", }, },
			c5: { ours_resemblance__: { q7_3__verse5_str: "off", }, },
			c6: { ours_resemblance__: { q7_3__verse6_str: "off", }, },
			c7: { ours_resemblance__: { q7_3__verse7_str: "off", }, },
		},
	};	

	db.o_accepting_resemblance__ = { 
		htm_stm: "o_accepting_resemblance",
		htm_nam: "o_accepting_resemblance_nm",
		context: ["ctx_people_resemblance", ],
		activated_if: {
			c1: { q_resemblance__: { a_simple_NO: "on", }, ours_resemblance__: { q7_3__verse1_str: "on", q7_3__verse2_str: "on", q7_3__verse3_str: "on", q7_3__verse4_str: "on", q7_3__verse5_str: "on", q7_3__verse6_str: "on", q7_3__verse7_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_for_all__ = { 
		htm_stm: "o_accepting_for_all",
		htm_nam: "o_accepting_for_all_nm",
		context: ["ctx_people_for_all", ],
		activated_if: {
			c1: { q_for_all__: { a_simple_NO: "on", }, ours_for_all__: { q8_1__verse1_str: "on", q8_1__verse2_str: "on", q8_1__verse3_str: "on", q8_1__verse4_str: "on", q8_1__verse5_str: "on", q8_1__verse6_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_not_yet__ = { 
		htm_stm: "o_accepting_not_yet",
		htm_nam: "o_accepting_not_yet_nm",
		context: ["ctx_people_not_yet", ],
		activated_if: {
			c1: { q_not_yet__: { a_simple_NO: "on", }, ours_not_yet__: { q9_1__verse1_str: "on", q9_1__verse2_str: "on", q9_1__verse3_str: "on", q9_1__verse4_str: "on", q9_1__verse5_str: "on", q9_1__verse6_str: "on", q9_1__verse7_str: "on", 
			}, },
		},
	};	
	...
	db.o_accepting_new_earth__ = { 
		htm_stm: "o_accepting_new_earth",
		htm_nam: "o_accepting_new_earth_nm",
		context: ["ctx_people_new_earth", ],
		activated_if: {
			c1: { q_new_earth__: { a_simple_NO: "on", }, ours_in_new_earth__: { q11_1__verse1_str: "on", q11_1__verse2_str: "on", q11_1__verse3_str: "on", q11_1__verse4_str: "on", 
			}, },
		},
	};	
