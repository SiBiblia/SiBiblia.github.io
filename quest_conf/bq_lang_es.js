...
function init_es_basic_msg(){
	...
	obj.msg_green_note = `es punto BUENO.`;
	obj.msg_red_note = `es punto MALO.`;
	obj.msg_perc_note = `% es el porcentaje de otras personas que respondieron como Ud.`;
	...
	obj.msg_sibiblia_link = "SiBib Enlace";
	obj.msg_sibiblia_id = "SiBib ID";
	obj.msg_sibiblia_photo = "SiBib foto";
	...
	obj.msg_usr_type_alias = "Escriba un alias. Lo encontraran por este en SiBiblia.com";
...
function ini_glb_vars_es(all_vars){
	...
	all_vars.glb_all_prt_books = num2prt_book_es;
