...
function init_en_basic_msg(){
	...
	obj.msg_there_are_none = "There are none";
	obj.msg_chaged_mind = "It seems you changed your mind. Very good.";
	...
	obj.msg_sibiblia_qr = "SiBib QR";
	obj.msg_sibiblia_link = "SiBib Link";
	obj.msg_sibiblia_id = "SiBib ID";
	obj.msg_sibiblia_photo = "SiBib Photo";
	obj.msg_usr_nequi = "Nequi";
	obj.msg_usr_paypal = "Paypal email";
	obj.msg_usr_transfiya = "Transfiya";
	obj.msg_usr_url_photo = "Photo URL";
	obj.msg_usr_pub_alias = "ALIAS";
	obj.msg_usr_type_alias = "Type an alias. They will find you by it in SiBiblia.com";
	...
	obj.msg_usr_referrer = "REFERRER";
	obj.msg_no_referrer = "Without referrer. ";
	obj.msg_type_referrer = "Type a valid user id or a valid user alias.";
	obj.msg_show_referrer = "Show data of referrer";
	
	obj.msg_usr_nominee = "NOMINEE";
	obj.msg_no_nominee = "Without nominee. ";
	obj.msg_type_nominee = "Type a valid user id or a valid user alias.";
	obj.msg_show_nominee = "Show data of nominee";
	
	obj.msg_usr_all_referred = "ALL REFERRED";
...
function ini_glb_vars_en(all_vars){
	...
	all_vars.glb_all_prt_books = num2prt_book_en;
